                ...
                "changes": [
                    {
                        "value": {
                            ...
                            "metadata": {
                                "display_phone_number": "94755263482",
                            ...
                            "messages": [
                                {
                                    ...
                                    "type": "text",
                                    "text": {
                                        "body": "I have 40 vegetarian meal boxes in Colombo 3 until 7 PM."
                                    }
                                }
                            ]
                        },
            ...
            "changes": [{
                "value": {
                    ...
                    "messages": [{
                        ...
                        "id": "wamid.msg1",
                        "type": "text",
                        "text": {"body": "I have 25 lunch packets ready."}
                    }]
                }
            }]
        }]
            ...
            "changes": [{
                "value": {
                    ...
                    "messages": [{
                        ...
                        "id": "wamid.recip_1",
                        "type": "text",
                        "text": {"body": "I need food for our community kitchen"}
                    }]
                }
            }]
        }]
        ...
        "entry": [{
            "changes": [{
                "value": {
                    ...
                    "messages": [{
                        "from": phone,
                        "id": "wamid.status_query_1",
                        "type": "text",
                        "text": {"body": "Where is my donation?"}
                    }]
                }
            }]
        }]
            ...
            "changes": [{
                "value": {
                    ...
                    "messages": [{
                        ...
                        "id": "wamid.edit_1",
                        "type": "text",
                        "text": {"body": "Actually I have 30 meals"}
                    }]
                }
            }]
        }]
...
def test_whatsapp_duplicate_webhook_idempotency(test_client):
            ...
            "changes": [{
                "value": {
                    ...
                    "messages": [{
                        ...
                        "id": duplicate_wamid,
                        "type": "text",
                        "text": {"body": "I have 50 meal boxes in Colombo."}
                    }]
                }
            }]
        }]
    ...
    repeat_res = pytest.importorskip("asyncio").run(
        whatsapp_handler.process_incoming_whatsapp_message(
            {"from": phone, "id": duplicate_wamid, "type": "text", "text": {"body": "repeat"}},
            {}
        )
    )
